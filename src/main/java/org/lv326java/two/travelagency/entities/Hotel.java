...
public class Hotel implements Entity {
    ...
    public static enum HotelEntityQueries {
        ...
        DELETE_BY_ID(SqlQueries.DELETE_BY_ID, "DELETE FROM hotels WHERE id = %s;"),
        DELETE_BY_FIELD(SqlQueries.DELETE_BY_FIELD, "DELETE FROM hotels WHERE %s = '%s';");
        //
        private SqlQueries sqlQuery;
        private String query;

        private HotelEntityQueries(SqlQueries sqlQuery, String query) {
